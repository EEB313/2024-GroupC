...
#Take all emmigrants from each patch and putting into a seperate coloumn 
```{r}
grid %>%  mutate(emmigrants = n * e)
```

#Distributing emmigrants into new patches in orignial grid data frame
```{r}

...
```{r testing step growth function}
...
```{r test world and parameters}
world <- list(p1 = list(n1 = 10, n2 = 5),
              p2 = list(n1 = 0, n2 = 0),
              p3 = list(n1 = 0, n2 = 0),
              p4 = list(n1 = 0, n2 = 0))
...
world_step_growth <- function(world, params, steps=1){
  for(t in 1:steps){
    now_world <- world
...
```{r test world step growth function}
#world_step_growth(world, params)
```

```{r}
migration_step <- function(world, steps=1){
  for (t in 1:steps){
    patches <- c(names(world))
